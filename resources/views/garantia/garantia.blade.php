                      ...
                      if(full.eliminado==0){
                        if(full.estado_d=="0"){
                          ...
                          '<button class="btn btn-white btn-icon" onclick="modificarDevolucion('+full.devoluciones[0].id+');" title="Ver"  data-bs-toggle="modal" data-bs-target="#modal-devolucion"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><circle cx="12" cy="12" r="2"></circle><path d="M22 12c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7"></path></svg></button>'+
                            '<button class="btn btn-white btn-icon" onclick="seguimiento('+full.id+');" title="Ver"  data-bs-toggle="modal" data-bs-target="#modal-seguimiento"><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><circle cx="12" cy="12" r="2"></circle><path d="M22 12c-2.667 4.667 -6 7 -10 7s-7.333 -2.333 -10 -7c2.667 -4.667 6 -7 10 -7s7.333 2.333 10 7"></path></svg></button>'+                              
                            ...
                            //<button class="btn btn-white btn-icon" onclick="modificar(1);" title="MODIFICAR"></button>
                                ...
                                '<div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">'+
                                  '<a href="javascript:void(0);" class="dropdown-item" onclick="derivarTramite('+full.estado+',1,'+full.id+');">Caja</a>'+
                                  '<a href="javascript:void(0);" class="dropdown-item"  onclick="derivarTramite('+full.estado+',2,'+full.id+');">Tributos</a>'+
                                  '<a href="javascript:void(0);" class="dropdown-item"  onclick="derivarTramite('+full.estado+',3,'+full.id+');" >Archivo de tesoreria</a>'+
                                '</div>'+
                              '</div></div>';
        ...
        <div  id="form_garantia" class="modal-body">
          ...
          <div class="row">
              <div class="col-lg-12">
                <div class="col-lg-6">
                  <div class="form-group mb-3">
                    <label class="form-label">Exp. SiAF ingreso</span></label>
              ...
              <div class="col-lg-6">
                <div class="form-group mb-3">
                  <label class="form-label">Monto<span class="form-required">*</span></label>
                  <input type="text"  class="number form-control mayuscula" id="monto"  name="example-text-input" placeholder="" onchange="decimal(this);">
                </div>               
              </div>
              <div class="col-lg-6">
                <div class="form-group mb-3">
